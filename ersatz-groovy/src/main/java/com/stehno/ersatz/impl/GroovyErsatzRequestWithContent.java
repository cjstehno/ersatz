...
public class GroovyErsatzRequestWithContent extends ErsatzRequestWithContent implements GroovyRequestWithContent {

    public GroovyErsatzRequestWithContent(final HttpMethod method, final Matcher<String> pathMatcher, final RequestDecoders globalDecoders, final ResponseEncoders globalEncoders) {
        super(method, pathMatcher, globalDecoders, globalEncoders);
    }

    public GroovyErsatzRequestWithContent(final HttpMethod method, final Matcher<String> pathMatcher) {
