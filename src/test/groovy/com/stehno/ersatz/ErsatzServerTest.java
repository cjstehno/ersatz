...
public class ErsatzServerTest {
    ...
    public void prototype() throws IOException {
        ...
        ersatzServer.expectations(expectations -> {
            ...
            expectations.POST("/form").body("some content", "text/plain; charset=utf-8").decoder(TEXT_PLAIN,  Decoders.utf8String)
                .responds().body("response");

            expectations.PUT("/update").body("more content", "text/plain; charset=utf-8").decoder(TEXT_PLAIN, Decoders.utf8String)
                .responds().body("updated");

            expectations.DELETE("/remove").responds().body("removed");

            expectations.POST("/patch").body("a change", "text/plain; charset=utf-8").decoder(TEXT_PLAIN, Decoders.utf8String)
