...
public class Cookie {
 ...
 public    static Cookie cookie(@DelegatesTo(value = Cookie.class, strategy = DELEGATE_FIRST) final Closure closure) {
    ...
    @Override public String toString() {
        return format("Cookie{value='%s', comment='%s', domain='%s', path='%s', version=%d, httpOnly=%s, maxAge=%d, secure=%s}", value, comment, domain, path, version, httpOnly, maxAge, secure);
    }
}