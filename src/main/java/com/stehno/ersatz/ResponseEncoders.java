...
public class ResponseEncoders {
    ...
    public void register(final String contentType, final Class objectType, final Function<Object, String> encoder) {
        try {
            encoders.add(new EncoderMapping(new MimeType(contentType), objectType, encoder));
    ...
    public Function<Object, String> findEncoder(final String contentType, final Class objectType) {
        ...
        return encoders.stream()
            .filter(em -> em.getContentType().match(mime) && em.getObjectType().isAssignableFrom(objectType))
            .findFirst()
            .map(EncoderMapping::getEncoder)
            .orElse(null);
    }
    ...
    private static class EncoderMapping {
        ...
        EncoderMapping(final MimeType contentType, final Class objectType, final Function<Object, String> encoder) {
