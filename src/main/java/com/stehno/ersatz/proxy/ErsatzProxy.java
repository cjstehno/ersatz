...
public class ErsatzProxy {
    ...
    public void start() {
        if (!started) {
            ...
            // TODO: this appears to be a deprecated approach
            final ProxyHandler proxyHandler = new ProxyHandler(client, null);
            ...
            builder.setHandler(new BlockingHandler(new HttpHandler() {
                @Override public void handleRequest(HttpServerExchange exchange) throws Exception {
                    ...
                    boolean matched = matchers.stream().anyMatch(m -> m.matches(clientRequest));
                    if (!matched) {
    ...
    public boolean verify() {
        for (ProxyRequestMatcher matcher : matchers) {
