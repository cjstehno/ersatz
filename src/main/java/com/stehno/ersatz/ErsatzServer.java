...
public class ErsatzServer implements Closeable {
    ...
    private final ServerConfigImpl serverConfig = new ServerConfigImpl(this::start);
    private final UnderlyingServer underlyingServer;

    public ErsatzServer() {
        underlyingServer = new UndertowUnderlyingServer(serverConfig);
    }
    ...
    public ErsatzServer(@DelegatesTo(value = ServerConfig.class, strategy = DELEGATE_FIRST) final Closure closure) {
        ConsumerWithDelegate.create(closure).accept(serverConfig);
        underlyingServer = new UndertowUnderlyingServer(serverConfig);
    }
    ...
    public int getHttpPort() {
        return underlyingServer.getHttpPort();
    }
    ...
    public int getHttpsPort() {
        return underlyingServer.getHttpsPort();
    }
    ...
    public String getHttpUrl() {
        return underlyingServer.getHttpUrl();
    }
    ...
    public String getWsUrl() {
        return underlyingServer.getWsUrl();
    }
    ...
    public String getHttpsUrl() {
        return underlyingServer.getHttpsUrl();
    }
    ...
    public String httpUrl(final String path) {
        return underlyingServer.getHttpUrl(path);
    }
    ...
    public String httpsUrl(final String path) {
        return underlyingServer.getHttpsUrl(path);
    }
    ...
    public ErsatzServer expectations(@DelegatesTo(value = Expectations.class, strategy = DELEGATE_FIRST) final Closure closure) {
        serverConfig.expectations(closure);
        return this;
    }
    ...
    public boolean verify(final long timeout, final TimeUnit unit) {
        return serverConfig.verify(timeout, unit);
    }
}
