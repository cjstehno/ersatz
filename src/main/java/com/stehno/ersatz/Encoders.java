...
public class Encoders {
     ...
     */
    public static final Function<Object, String> binaryBase64 = obj -> obj instanceof byte[] ? getEncoder().encodeToString((byte[]) obj) : "";
     ...
     */
    public static final Function<Object, String> multipart = new Function<Object, String>() {
        @Override
        public String apply(final Object obj) {
            if (!(obj instanceof MultipartRequestContent)) {
                throw new IllegalArgumentException("Content must be instance of MultipartResponseContent!");
            }
            ...
            mrc.parts().forEach(p -> {
                ...
                out.append(mrc.encoder(p.getContentType(), p.getValue().getClass()).apply(p.getValue())).append("\r\n");
            });
