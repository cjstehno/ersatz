...
import static com.stehno.ersatz.util.StorageUnit.BYTES;
...
public class DummyContentGenerator {
     ...
     */
    public static byte[] generate(final double size, final StorageUnit unit) {
        int count = (int) BYTES.approximate(size, unit);
