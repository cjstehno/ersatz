...
public class WebSocketsHandlerBuilder {
    ...
    public WebSocketsHandlerBuilder(final ExpectationsImpl expectations, final HttpHandler defaultHandler, final boolean mismatchToConsole) {
    ...
    public HttpHandler build() {
        Set<String> wsPaths = expectations.getWebSocketPaths();
