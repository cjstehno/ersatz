...
public class ErsatzMultipartResponseContent extends MultipartResponseContent {
    ...
    public MultipartResponseContent part(String fieldName, String fileName, String contentType, Object value) {
        return part(fieldName, fieldName, contentType, value, null);
    }
    ...
    public Function<Object, String> encoder(final String contentType, final Class objectType) {
        ...
        throw new IllegalArgumentException(format("No encoder found for content-type (%s) and object type (%s}).", contentType, objectType.getSimpleName()));
    }
}
