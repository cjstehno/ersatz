...
public class UndertowClientRequest implements ClientRequest {
    ...
    // FIXME: this class is server-specific
    ...
    public String toString() {
        ...
        final byte[] contentBytes = getBody();

        if (contentBytes != null && (getContentType() != null && getContentType().startsWith("text/"))) {
    ...
    public String getContentType() {
        final HeaderValues values = exchange.getRequestHeaders().get(CONTENT_TYPE_HEADER);
